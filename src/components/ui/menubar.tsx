...
function Menubar({
  ...
  return (
    <MenubarPrimitive.Root
      data-slot="menubar"
      className={cn(
        "bg-white flex items-center gap-1 rounded-md  shadow-xs dark:bg-neutral-950 dark:border-neutral-800",
        className
      )}
      {...props}
    />
...
function MenubarTrigger({
  ...
  return (
    <MenubarPrimitive.Trigger
      ...
      className={cn(
        "focus:bg-neutral-100 rounded-full focus:text-neutral-900 data-[state=open]:bg-neutral-100 data-[state=open]:text-neutral-900 flex items-center  text-sm font-medium outline-hidden select-none dark:focus:bg-neutral-800 dark:focus:text-neutral-50 dark:data-[state=open]:bg-neutral-800 dark:data-[state=open]:text-neutral-50",
        className
      )}
      {...props}
    />
